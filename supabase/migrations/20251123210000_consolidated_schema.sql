...
-- ORDERS
-- Public read allowed via code (unguessable) for tracking
...
-- (Optional) You can add initial products or pharmacies here if desired.

-- ==========================================
-- 6. ADMIN SETUP
-- ==========================================
-- Assign ADMIN role to the default admin user
-- REPLACE 'admin@discreetkit.com' WITH YOUR ACTUAL EMAIL IF DIFFERENT
