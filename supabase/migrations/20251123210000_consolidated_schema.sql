...
COMMENT ON TABLE public.reviews IS 'Anonymous user reviews and testimonials.';

-- Enable RLS
alter table public.reviews enable row level security;

-- Allow anonymous inserts (anyone can leave a review)
create policy "Enable insert for everyone" on public.reviews
  for insert with check (true);

-- Allow public read access
create policy "Enable read for everyone" on public.reviews
