...
export default function NotFound() {
  return (
    <div className="flex min-h-full items-center justify-center bg-background p-4 text-center">
      <div className="flex flex-col items-center">
        <Image
          src="https://images.unsplash.com/photo-1578328819058-b69f3a3b0f6b?w=600&h=450&fit=crop&q=75"
          alt="An empty box, symbolizing a page not found."
          width={400}
          height={300}
        ...
        <p className="mt-4 max-w-md text-base text-muted-foreground">
          It looks like the admin page you're searching for doesn't exist. Let's get you back on track.
        </p>
