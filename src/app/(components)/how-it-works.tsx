      ...
      <div className="container mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div className="md:hidden">
          ...
          >
            <CarouselContent>
              {steps.map((step) => (
                <CarouselItem key={step.number} className="basis-full sm:basis-3/4">
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step) => (
            <div key={step.number} className="h-full">
              <Card className="h-full flex flex-col p-6 shadow-lg transition-all hover:shadow-xl hover:-translate-y-1">
                <CardContent className="p-0 flex flex-col flex-grow">
                    <div className="flex items-center gap-4 mb-4">
                        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10">
                            <step.icon className="h-6 w-6 text-primary" strokeWidth={1.5} />
