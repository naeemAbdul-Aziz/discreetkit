      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="mt-2 font-headline text-2xl font-bold text-foreground md:text-3xl">
            From Our Kit to Their Care: Your 4-Step Journey
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-base text-muted-foreground">
            Here's a clear, simple path from ordering your test to getting professional support.
          </p>
        </div>
        ...
        <div className="hidden md:grid md:grid-cols-1 gap-16 max-w-5xl mx-auto">
            {partnerCareSteps.map((step, index) => (
                 <div
                    key={step.number}
                 >
