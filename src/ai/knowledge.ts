...
-   **Discount Amount:** Varies by product. See product pages for details.
...
1.  **Order Your Products:** Choose your health essentials and pay securely online with mobile money or a card.
2.  **Private & Fast Delivery:** Receive your items in a plain package at your location or a partner pharmacy.
3.  **Get Your Results:** For test kits, use the simple instructions to get a result in under 20 minutes.
4.  **Get Support (If Needed):** For a positive test result, we provide confidential connections to partner hospitals for professional, discounted follow-up care.
...
## Refunds & Returns
Due to the medical and personal nature of our products, all sales are final. We cannot accept returns. If a product arrives damaged, the user should contact us within 24 hours with their order code for a replacement.
`;
